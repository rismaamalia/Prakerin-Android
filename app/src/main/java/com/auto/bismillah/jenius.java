...
public class jenius extends AppCompatActivity {
    ...
    public void setKonten(){
        ...
        arr = soalPG.jenius.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(jenius.this, hasil_skoring.class);
            ...
            mtvSoal.setText(soalPG.getPertanyaanJenius(x));
            mrbPilihanJawaban1.setText(soalPG.getPilihanJawaban1jenius(x));
            mrbPilihanJawaban2.setText(soalPG.getPilihanJawaban2jenius(x));
            mrbPilihanJawaban3.setText(soalPG.getPilihanJawaban3jenius(x));
            jawaban = soalPG.getJawabanBenarJenius(x);
