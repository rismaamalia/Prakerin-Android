...
public class cerdas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cerdas);
    ...
    public void setKonten(){
        ...
        arr = soalPG.cerdas.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(cerdas.this, hasil_skoring.class);
            ...
            mtvSoal.setText(soalPG.getPertanyaanCerdas(x));
            mrbPilihanJawaban1.setText(soalPG.getPilihanJawaban1cerdas(x));
            mrbPilihanJawaban2.setText(soalPG.getPilihanJawaban2cerdas(x));
            mrbPilihanJawaban3.setText(soalPG.getPilihanJawaban3cerdas(x));
            jawaban = soalPG.getJawabanBenarCerdas(x);
